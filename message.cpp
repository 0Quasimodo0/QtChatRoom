...
void customMessage::addMessage(const QString msg, messageType type)
{
    if(type==Me){
...
QWidget *customMessage::customMessageItem(const QString message, const QString userName, messageType type)
{

}

/*void customMessage::customMessageItem(messageType type)
{
    QPainter painter;
